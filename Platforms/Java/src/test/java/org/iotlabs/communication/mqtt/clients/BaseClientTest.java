...
public class BaseClientTest {
    ...
    public void subscribeAndPublish() throws Exception {
        ...
        MqttProxy.getInstance().registerReceivers(
                new File(getClass().getClassLoader().getResource("test_mqtt_receiver.json").toURI()).getAbsolutePath(),
                new MqttProxy.SimpleMqttCallback() {
                    @Override
        ...
        MqttProxy.getInstance().initPublisherPool(5, "tcp://localhost:1883", true);
